...
public class UsuarioListController {
    ...
    /** Carga los usuarios desde BD (con nombre de rol y división) y rellena la tabla */
    private void cargar() {
        String sql = """
    ...
    private void configurarAcciones() {
        colAcciones.setCellFactory(col -> new TableCell<>() {
            ...
            final HBox box = new HBox(6, btnEditar);
            {
                // Icono de editar
    ...
    private void nuevo() {
        try {
            FXMLLoader fx = new FXMLLoader(getClass().getResource("/utez/edu/mx/prestamos_utez/view/usuario_form.fxml"));
            Parent root = fx.load();
    ...
    private void abrirFormEdicion(Usuario u) {
        try {
            ...
            c.setUsuario(
                    ...
                    u.getCorreo(),
                    u.getIdRol(),
                    u.getNombreRol(), // pásalo si ya viene
                    this::cargar
            );
