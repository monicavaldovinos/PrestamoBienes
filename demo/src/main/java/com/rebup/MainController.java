...
public class MainController {
    ...
    public void initialize() {
        ...
        var dao = new com.rebup.dao.ProfesorDao();
        var data = javafx.collections.FXCollections.observableArrayList(dao.listar());
        

        var filtrado = new javafx.collections.transformation.FilteredList<>(data, p -> true);
